...
readonly G_USER_PACKAGES="xterm nvme-cli vim emacs gedit pciutils alsa-tools alsa-utils alsaplayer-text wget htop bwm-ng xwayland python3-pip python3-periphery"
