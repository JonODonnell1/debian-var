...
install -m 755 systemd/scripts/m5pro.sh       ../rootfs/usr/lib/systemd/scripts
install -m 644 systemd/m5pro-start.service    ../rootfs/usr/lib/systemd/system
install -m 644 systemd/m5pro-shutdown.service ../rootfs/usr/lib/systemd/system
